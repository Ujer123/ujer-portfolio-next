            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className={`absolute top-3 right-3 flex gap-2 transition-all duration-300 ${
                  ...
                  <button className="p-2 bg-black/70 hover:bg-purple-600/80 text-white rounded-lg backdrop-blur-sm transition-colors duration-200">
              ...
              <div className="relative p-4 sm:p-6 space-y-3 sm:space-y-4">
                ...
                <div className="flex gap-3 pt-3 border-t border-gray-700/50">
                  <button className="flex-1 py-2 px-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-sm font-medium rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900">
                    View Project
                  </button>
                  <button className="py-2 px-4 border border-gray-600 hover:border-purple-500 text-gray-300 hover:text-white text-sm font-medium rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900">
                    Code
                  </button>
                </div>
              </div>
